...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { name: @bookmark.name, tag_id: @bookmark.tag_id, url: @bookmark.url } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { name: @bookmark.name, tag_id: @bookmark.tag_id, url: @bookmark.url } }
